...
def save_original_info(source_func):
    """
    Decorator that passes original func' doc, name to the wrapper and
    puts original func to the wrapper attribute __original_func.
    Analog of itertools.wraps decorator.
    """
    def wrapping(recipient_func):
        recipient_func.__doc__ = source_func.__doc__
        recipient_func.__name__ = source_func.__name__
        recipient_func.__original_func = source_func
